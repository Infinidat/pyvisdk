...
.. describe:: ClusterDasFdmAvailabilityState
    ...
    .. py:data:: ClusterDasFdmAvailabilityState.connectedToMaster
    ...
    .. py:data:: ClusterDasFdmAvailabilityState.election
    ...
    .. py:data:: ClusterDasFdmAvailabilityState.fdmUnreachable
    ...
    .. py:data:: ClusterDasFdmAvailabilityState.hostDown

        The slave host appears to be down. This state is reported by the master of a slave host.

    
    .. py:data:: ClusterDasFdmAvailabilityState.initializationError
    ...
    .. py:data:: ClusterDasFdmAvailabilityState.master

        The Fault Domain Manager on the host has been elected a master. This state is reported by the the host itself.

    
    .. py:data:: ClusterDasFdmAvailabilityState.networkIsolated

        A host is alive but is isolated from the management network. See ClusterDasVmSettingsIsolationResponse for the criteria used to determine whether a host is isolated.

    
    .. py:data:: ClusterDasFdmAvailabilityState.networkPartitionedFromMaster

        A slave host is alive and has management network connectivity, but the management network has been partitioned. This state is reported by masters that are in a partition other than the one containing the slave host; the master in the slave's partition will report the slave state as connectedToMaster.

    
    .. py:data:: ClusterDasFdmAvailabilityState.uninitializationError
    ...
    .. py:data:: ClusterDasFdmAvailabilityState.uninitialized
